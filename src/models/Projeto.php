...
class Projeto
{
    ...
    -- Total e média de avaliações por gênero
    ...
    -- Total e média de avaliações por faixa etária
...
FROM 
    ...
    -- Subquery para evitar duplicação de avaliações
    LEFT JOIN (
        SELECT 
            a.id_projeto,
...
";
        ...
        if ($result) {
            ...
            // Adiciona o campo de "popularidade" para cada projeto
            foreach ($projetos as &$projeto) {
                // Verifica se o projeto é popular entre adultos e jovens
