<div class="projeto-padrao">
    ...
    <div class="projeto-tags">
        <?php if ($popularJovens): ?>
            <img src="./src/assets/images/icone-jovem.svg" alt="" class="tag-jovem tag"
                title="Popular entre jovens de 0 a 21 anos">
        <?php endif; ?>

        <?php if ($popularAdultos): ?>
            <img src="./src/assets/images/icone-adulto.svg" alt="" class="tag-adulto tag"
                title="Popular entre adultos de 22 a 59 anos">
        <?php endif; ?>

        <?php if ($popularIdosos): ?>
            <img src="./src/assets/images/icone-idoso.svg" alt="" class="tag-idoso tag"
                title="Popular idosos com mais de 60 anos">
        <?php endif; ?>

        <?php if ($popularHomens): ?>
            <img src="./src/assets/images/icone-homem.svg" alt="" class="tag-homem tag" title="Popular entre homens">
        <?php endif; ?>

        <?php if ($popularMulheres): ?>
            <img src="./src/assets/images/icone-mulher.svg" alt="" class="tag-mulher tag" title="Popular entre mulheres">
        <?php endif; ?>
