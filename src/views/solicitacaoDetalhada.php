        ...
        <main class="solicitacao">
            ...
            <div class="projeto-info">
                ...
                <div class="projeto-info-desc">
                    <?php foreach ($projetoCursos as $curso): ?>
            ...
            <div class="projeto-info">
                ...
                <div class="projeto-info-desc">
                    <?php foreach ($projetoTemas as $tema): ?>
                        <p><?php echo htmlspecialchars($tema['nome']); ?></p>
                    <?php endforeach; ?>
                </div>
            </div>
            <div class="projeto-info">
        ...
        <body>
            <header>
                ...
                <?php if (!isset($usuario)): ?>
                    <a href="./cadastroUsuario.php" class="link-header">Cadastre se ou consulte o ID</a>
                <?php endif; ?>
                <a href="./perfilAluno.php" class="botao-padrao"><i class="fa-solid fa-arrow-left"></i>
                    Voltar</a>
            </header>
            <main class="solicitacao">
                <p>O projeto será apresentado dessa forma na tela de DETALHES:</p>
                ...
                <?php if ($projetoMaterialApoio): ?>
                    <a href="./../<?php echo $projetoMaterialApoio ?>" class="botao-padrao" target="_blank">Clique aqui para
                        acessar
                        o
                        material</a>
                <?php endif; ?>
                <?php if (isset($usuarioAdm)): ?>
                    ...
                    <a href="./editarProjeto.php?projeto=<?= $projetoId ?>" class="botao-padrao botao-editar">Editar projeto</a>
                <?php endif; ?>
                <?php if (isset($usuarioAluno)): ?>
                    <a href="./editarSolicitacao.php?projeto=<?= $projetoId ?>" class="botao-padrao botao-editar">Editar
                        projeto</a>
                <?php endif; ?>
            </main>
            ...
            <section class="revisao-section">
                <?php if (!empty($projeto['comentarios'])): ?>
                    <div class="comentarios-professor">
                        <h3>Comentários do Professor</h3>
                        <ul>
                            <?php foreach ($projeto['comentarios'] as $campo => $comentario): ?>
                                <li><strong><?= htmlspecialchars($campo) ?>:</strong> <?= nl2br(htmlspecialchars($comentario)) ?>
                                </li>
                            <?php endforeach; ?>
                        </ul>
                    </div>
                <?php else: ?>
                    <p>Nenhum comentário do professor disponível.</p>
                <?php endif; ?>
